...
public class board_reply implements board_action {
    ...
    public String action(HttpServletRequest request, HttpServletResponse response) throws IOException {
    	...
    	//메일보내기
    	final String username="hanginth1081@naver.com";
    	final String password="LFM246726RJN";
    	
    	Properties prop = new Properties();
    	prop.put("mail.smtp.starttls.enable", "true");//tls 사용여부
    	prop.put("mail.smtp.auth", "true");//smtp서버인증
    	prop.put("mail.smtp.host", "smtp.naver.com");//이메일 전송 smtp서버명
    	...
    	try {//메세지 생성
    		...
    		msg.setSubject(org.getTitle()+" 게시글 알림");//제목
    		
    		msg.setText(org.getTitle()+" 게시글에 " +user.getName()+ 
    				"님이 답글이 등록되었습니다. 확인하시려면 아래 링크를 클릭해주세요.\n"+
    				"http://192.168.0.41/board_read.do?id="+bid,"UTF-8");//내용
