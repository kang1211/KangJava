...
<c:if test="${user.image !=null }">
	<c:set var="img" value="style='background:url(http://192.168.0.41/static/image/${user.image }) no-repeat center; background-size:contain;'"/>
</c:if>    
...
<div id="info_wrap">
	...
	<div id="grid">
		...
		<div class="item email_box">E-mail : <b>${sessionScope.user.email}</b></div>
		
		<div class="item name_box">이름 : <input type="text" name="name" id="name" value="${sessionScope.user.name }"></div>
		
		<div class="item tel_box">Tel. : <input type="text" name="tel" id="tel" value="${user.tel }"></div>
