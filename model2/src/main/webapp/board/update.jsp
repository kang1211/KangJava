	...
	<div id="write_box">
		...
		<div class="input_box">
			...
			<select name="lang" id="lang">
				...
				<option vlaue="c++" ${data.lang == 'c++' ? 'selected':''}>c++</option>
				<option vlaue="c#" ${data.lang == 'c#' ? 'selected':''}>c#</option>
				<option vlaue="ruby" ${data.lang == 'ruby' ? 'selected':''}>ruby</option>
				<option vlaue="swift" ${data.lang == 'swift' ? 'selected':''}>swift</option>
				<option vlaue="perl" ${data.lang == 'perl' ? 'selected':''}>perl</option>
				<option vlaue="go" ${data.lang == 'go' ? 'selected':''}>go</option>
			</select>
		</div>
...
<script>
	$("#content").summernote({
		...
		height:300,
		toolbar:[['font',['bold','underline','fontsize','forecolor','color']]]
	});
</script>