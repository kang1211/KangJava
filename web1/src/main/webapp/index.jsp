...
<%-- 스크립틀릿 주석
내장객체 - jsp파일이 서버에서 실행될 때 참조되는 객체들이다.
확장자를 jsp라고 해주어야 내장객체를 사용할 수 있다. 예외는 있다. ->타임리프 같은거 사용할때
내장객체의 종류
	...
	application - 서버의 정보를 가지고있는 객체, 서버에 단 하나만 존재하는 객체
	out - 출력용 객체
	page - 특정 페이지의 서블릿객체, jsp페이지의 다른 내장객체들에 접근이 가능하다.
	pageContext - 현재 jsp페이지에 실행가능한 정보를 저장하고있는 객체, 다음 내장객체 접근 가능
	config - 서블릿 설정정보를 가지고있는 객체
	exception - 예외처리객체                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
--%>
