...
public class test2 {
	...
	public static void main(String[] args) {
		...
		// flastMap - score 객체에서 추출해야 할 값이 하나가 아니라 다수이기 때문에 map이 아니라
		// 			  flatmap을 사용한다.
		...
		System.out.println("40보다 큰 값이 있나? "+any);
		...
		System.out.println("50보다 큰 숫자 없니? "+ none);
