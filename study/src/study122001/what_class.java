...
public class what_class {
	public static void main(String[] args) {
		...
		// 변수 - 지역변수, 인스턴스변수, 클래스변수, 참조변수
		// 인스턴스변수 - 클래스의 멤버 변수(클래스 객체의 실제 데이터를 저장하는 변수)
		// 클래스변수 - 클래스의 전역변수
		
//		car c1=new car(); // 클래스의 객체생성(인스턴스 생성)
//		c1.carNum=12300;// c1 참조변수
//		c1.carName="소나타";
//		
//		System.out.println(c1);
//		
//		car c2=new car();
//		c2.carNum=12400;//c2 참조변수
//		c2.carName="그랜저";
//		
//		System.out.println(c2);
//		
//		car[] c = new car[10];// car 클래스의 참조변수공간 10개 생성 배열함수에서는 객체생성에 작은괄호()가 없기때문에 공간이 없다
//		
//		for(int i=0;i<c.length;i++) {
//			c[i] = new car(); // car 클래스의 객체 생성(인스턴스변수와 메서드 공간생성)
//			c[i].carNum = i+10000+(int)(Math.random()*10000); //괄호로 묶는이유
//			c[i].carName="쏘렌토";
//		}
//	 
...
class car{ // 클래스명이 car인 클래스 정의, 클래스의 정의부분이고 공간생성이 아니다.
	int carNum; //인스턴스변수
