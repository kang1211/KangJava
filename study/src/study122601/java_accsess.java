...
public class java_accsess {
	...
	public static void main(String[] args) {
		...
		// book.title="C언어"; Static이 붙지 않아 아직 생성되지 못한 변수
		book.cnt=1;// 클래스 변수이기 때문에 객체 생성없이 사용가능
		book bk = new book(); // 객체생성
...
//생성자 class 오버로딩(중복 메서드 사용) 필히 익혀야 할 것

// 제어자 - 클래스, 변수, 메서드
// 접근제어자 - public, private, protected, default
// static, final, abstract 까지는 반드시 알아야 하는 접근제어자 그외 native 등등
